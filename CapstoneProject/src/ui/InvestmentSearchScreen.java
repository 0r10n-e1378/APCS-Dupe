...
/**
 * The {@code InvestmentSearchScreen} class represents the screen where users can search
 ...
 */
public class InvestmentSearchScreen implements Screen {
    ...
    /**
     * Constructs an {@code InvestmentSearchScreen} with the specified drawing surface
     ...
     */
    public InvestmentSearchScreen(DrawingSurface surface, AppController controller) {
        ...
        if (useCSVBtn.contains(p)) {
            ...
            if (!ticker.isEmpty()) {
                ...
                if (d != null) {
                    ...
                    status = "Data for " + t;
                    SimulationScreen.setTicker(ticker);
                } else {
