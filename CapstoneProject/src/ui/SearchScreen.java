...
/**
 * The {@code SearchScreen} class represents the screen where users can search
...
public class SearchScreen implements Screen {
    ...
    private GraphingScreen gScreen;

    /**
     * Constructs an {@code SearchScreen} with the specified drawing surface
     ...
     */
    public SearchScreen(DrawingSurface surface, AppController controller, GraphingScreen gScreen) {
     ...
     * Switches back to graphing screen if exit button is clicked.
     */
